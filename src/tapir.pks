create or replace package tapir authid current_user is
    ...
    */
    type defaults_t is record(
        use_column_defaults         boolean default true,
    ...
    *   proc_insert_cur                If not null, the name of the procedure to insert records into the table returned by the given cursor.
    */
    ...
    */
    type export_format_t is record(
        date_f   obj_col default gc_date_format_iso_8601,
    ...
    *       parameter_prefix
    *       warn_about_null_string_default Raises an exception during generating TAPI, when encountering the string 'null' as column default value in data dictionary
